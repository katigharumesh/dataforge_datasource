...
def load_input_sources_producer(sources_queue, request_id, queue_empty_condition, thread_count, main_logger):
...
def main(request_id, run_number):
    try:
        ...
        producer_thread = threading.Thread(target=load_input_sources_producer, args=(sources_queue, request_id, queue_empty_condition, THREAD_COUNT, main_logger))

...
ERROR_CODES = {
    'DO1': "Error occurred while importing Input data sources - Out of '{n}' input sources, '{m}' input sources are unable to process. SourceId: {sourceId}, Error: {error}",
    ...
    'DO5': "Unable to process the request as selected {filter_type} Id {id} is inactive",
    'DO6': "Unknown Exception occurred while validating the active state of {filter_type}. Error: {error}",
    'DO7': "The service is unable to perform ISP filtration. Error: {error}",
    'DO8': "The service is unable to perform profile non-match suppression. Error: {error}",
    'DO9': "The service is unable to perform match process for the channel match data. Error: {error}",
    'DO10': "The service is unable to perform suppression process for the channel suppression data. Error: {error}",
    'DO11': "The service is unable to perform request level match process. Error: {error}",
    'DO12': "The service is unable to perform request level filters. Error: {error}",
    'DO13': "The service is unable to perform global suppression. Error: {error}",
    'DO14': "The service is unable to perform feed-level suppression. Error: {error}",
    'DO15': "The service is unable to perform zip code suppression. Error: {error}",
    'DO16': "The service is unable to perform state suppression. Error: {error}",
    'DO17': "The service is unable to perform Purdue suppression. Error: {error}",
    'DO18': "The service is unable to perform offer suppression. Error: {error}",
    'DO19': "The service is unable to perform match process for offer match data. Error: {error}",
    'DO20': "The service is unable to perform suppression process for offer suppression data. Error: {error}",
    'DO21': "Unknown Exception occurred while processing the {request_type}. Error: {error}",
    'DO22': "The service is unable to summarize the request metrics. Error: {error}",
    'DO23': "Unknown Exception occurred while summarizing the request metrics. Error: {error}",
    'DO24': "The service is unable to connect to Snowflake DB. Error: {error}",
    'DO25': "The service is unable to connect to MySQL DB. Error: {error}",
}
